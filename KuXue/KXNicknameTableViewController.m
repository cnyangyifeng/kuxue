//
//  KXNicknameTableViewController.m
//  KuXue
//
...
@interface KXNicknameTableViewController ()

@end

@implementation KXNicknameTableViewController
...
{
    UIView *nicknameTextFieldPadding = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 10.0f, self.nicknameTextField.frame.size.height)];
    self.nicknameTextField.leftView = nicknameTextFieldPadding;
